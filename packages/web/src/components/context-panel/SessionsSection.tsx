...
export function SessionsSection({ sessions, sessionId, expandedSection, onToggleSection, onSwitchSession, onDeleteSession, onCreateSession, onOpenSessionGraph }: Readonly<SessionsSectionProps>) {
  return (
    <ContextPanelSectionFrame
      section="sessions"
      expandedSection={expandedSection}
      onToggleSection={onToggleSection}
      title={<span><i className="codicon codicon-comment-discussion" /> Session</span>}
