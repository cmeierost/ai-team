...
export class ProviderListICommand implements ICommand<ListParams, void> {
  ...
  async execute(payload: ListParams, _ctx: ExecutionContext): Promise<CommandResponse<void>> {
    await providerListCommandAsync(payload as ProviderListOptions, this.configurationStorage);
    return { status: 'ok' };
  }
}
...
export class ProviderModelsICommand implements ICommand<ModelsParams, void> {
  ...
  async execute(payload: ModelsParams, _ctx: ExecutionContext): Promise<CommandResponse<void>> {
    await providerModelsCommandAsync(payload as ProviderModelsOptions, this.configurationStorage);
    return { status: 'ok' };
  }
}
...
export class ProviderModelsRefreshICommand implements ICommand<RefreshParams, void> {
  ...
  async execute(payload: RefreshParams, _ctx: ExecutionContext): Promise<CommandResponse<void>> {
    await providerModelsRefreshCommandAsync(
...
async function providerModelsRefreshCommandAsync(
  ...
  const discovered = await discoveryService.fetchModelsAsync(
