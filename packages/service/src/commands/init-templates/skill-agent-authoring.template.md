...
When shaping prompts or agent communication behavior, prefer concise-by-default responses and require an explicit user request before going into detailed explanations.
