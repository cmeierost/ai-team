...
describe('PermissionEngine — checkToolCall', () => {
  let engine: PermissionEngine;
  beforeEach(() => { engine = createEngine(); });
...
describe('PermissionEngine — batch operations', () => {
  let engine: PermissionEngine;
  beforeEach(() => { engine = createEngine(); });
...
describe('PermissionEngine — introspection', () => {
  let engine: PermissionEngine;
  beforeEach(() => { engine = createEngine(); });
...
describe('PermissionEngine — ignore patterns', () => {
  let engine: PermissionEngine;
  beforeEach(() => { engine = createEngine(); });
...
describe('PermissionEngine — context switching', () => {
  let engine: PermissionEngine;
  beforeEach(() => { engine = createEngine(); });
...
describe('PermissionEngine — organization fallback without .perm', () => {
