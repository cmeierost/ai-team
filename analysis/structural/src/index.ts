...
export {
  analysePackageAlignment,
  matchCommunityGroupsToPackages,
  comparePackages,
} from './6-package-comparison.js';
...
export {
  analyseClusterQuality,
  findSplitCandidates,
  generateWarnings,
  analyseStructuralAlignment,
...
export { computeShallownessDiagnostics } from './shallowness-diagnostics.js';
export {
...
export { buildLlmPriorityReader } from './priority-reader.js';
...
export type {
  ...
  PipelineGroupMismatch,
  PipelineMoveSuggestion,
  FileCentrality,
  PipelineRecommendation,
  RecommendationPriority,
  RecommendationCategory,
  LlmPriorityIssueSource,
  LlmPriorityIssue,
  ...
  ShallownessRemediationStrategy,
  ShallownessExportSurfaceHint,
  ShallownessClassificationRecommendation,
  ShallownessClassificationRecommendationStrategy,
...
export type { CommunityGlobFingerprint, CommunityGlobResult } from './7-community-globs.js';
export type {
  FileContextInput,
  ContextComparisonResult,
  ContextComparisonEntry,
  ContextCommunityCoverage,
  ContextGroupCoverage,
} from './10-context-comparison.js';
export type { FilesystemFitResult, DirectoryFitInfo, MisplacedFileInfo } from './filesystem-fit.js';
export type { MoveSuggestion, MoveImpact, MoveSuggestionResult } from './move-suggestions.js';
export type { ReferenceDiagnostics, FileReferenceDiagnostic } from './reference-diagnostics.js';
export type { CanonicalLocMetrics, FileLocMetrics } from './loc-metrics.js';
export type { NonQualifiedDiagnostics, FileNonQualifiedInfo } from './nonqualified-diagnostics.js';
export type {
  RoleSeparationMetrics,
  ClusterRoleSeparation,
  RepoRoleSummary,
} from './role-separation.js';
export type { EntityHierarchySummary, FileHierarchyInfo } from './hierarchy-analysis.js';
export type { InventorySummary, FileInventoryInput } from './inventory-summary.js';
export type { CoverageValidation } from './coverage-validation.js';
export type {
  EntityConcern,
  EntityConcernResult,
