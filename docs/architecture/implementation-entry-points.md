...
| Request-scoped stream correlation and event translation           | `packages/service/src/interaction-stream.ts`, `packages/service/src/orchestrator/services/emit-service.ts` |
